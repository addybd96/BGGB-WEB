...
class AddODComponent extends React.Component<any, any> {
    ...
    public render() {
        const { userId, sppay, sppayAmount, revisionSppay, specialization, date, nextIncDate, reason } = this.state;
        return (
            <React.Fragment>
    ...
    _submitForm = (e: any) => {
        ...
        if (validateForm(this)) {
            ...
            const model = {
                ...
                sppay: sppay.value,
                revisionSppay: revisionSppay.value ===null || undefined ? 0: revisionSppay.value,
