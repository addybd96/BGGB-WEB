            ...
            </PaginationProvider>
            {
                this.state.isModalOpen ?
                    <ModalWindow
                        ...
                        <ApprovalModal isModalOpen={isModalOpen} dismissModal={this.dismissModal} onSubmit={this.onSubmit.bind(this)} festivalStatusList={festivalStatusList} item={itemData} />
                    </ModalWindow>
                    : null
            }
        </React.Fragment>)
