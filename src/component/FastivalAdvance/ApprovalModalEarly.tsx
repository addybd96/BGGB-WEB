...
export default class EarlyApprovalModal extends React.Component<any, any>
{
    ...
    public render() {
        ...
        const { status, amount, remark, date, itemData } = this.state;
    ...
    _onSubmit = () => {
        ...
        if (this._validateForm()) {
            let payload = {
                ...
                amount: this.state.itemData.remainingAmount,
