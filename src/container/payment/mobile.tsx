...
import { getMobileAlneByUserId } from "../../action/payment";
...
class ComponentName extends React.Component<any, any> {
                          ...
                          list.map((l: any, i: any) => {
                            return (
                              <tr key={i}>
                                ...
                                {/* <td className="text-center">
                                                                    <Link to={`${CONSTANT.url.payment.updateTrans}?id=${l.id}&name=${l.name}(${l.employeeId})&sch=perquisites&tb=mobileAllowance`} >
  ...
  downloadToExcel = () => {
    ...
    let filename = "Mobile-allowance.xlsx";
    ...
    const data = list
      ...
      .map((item: any, index: number) => {
        ...
        dataToExport.push({
          ...
          Sol:item.soul,
          Particular: `Mobile allowance for the ${dateFormat(
            item.date,
            "mmmm-yyyy"
          )}`,
  ...
  loadData = (status?: any) => {
    ...
    getMobileAlneByUserId({ status }).then((res: any) => {
      status
        ? this.setState({
            showLoader: false,
            list: res ? res : "",
