...
import { getEntertenmentByUserId } from "../../action/payment";
...
class ComponentName extends React.Component<any, any> {
                          ...
                          list.map((l: any, i: any) => {
                            return (
                              <tr key={i}>
                                ...
                                {/* <td className="text-center">
                                  <Link
                                    to={`${CONSTANT.url.payment.updateTrans}?id=${l.id}&name=${l.name}(${l.employeeId})&sch=perquisites&tb=entertainmentAmount`}
                                  >
                                    <i
  ...
  downloadToExcel = () => {
    ...
    let filename = "entertainment.xlsx";
    ...
    const data = list
      ...
      .map((item: any, index: number) => {
        ...
        dataToExport.push({
          ...
          Sol:item.soul,
          Particular: `Entertainment allowance for the quarter of ( ${dateFormat(
            oldDate,
            "mmmm-yyyy"
          )} - ${dateFormat(
            item.toDate,
  ...
  loadData = (status?: any) => {
    ...
    getEntertenmentByUserId({ status }).then((res: any) => {
        debugger
      status
        ? this.setState({
            showLoader: false,
  ...
  downloadExcel = (l: any) => {
    ...
    let filename = "Entertainment-allowance.xlsx";
    let dataToExport: any = [];
    var ws_name = "Sheet1";
    const data = list
      .filter((item: any) =>
