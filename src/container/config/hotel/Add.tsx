...
import { addHotel, getHotelList, getDesignations } from '../../../action/SettingsActions'
...
class ComponentName extends React.Component<any, any> {
    ...
    componentDidMount() {
        ...
        this.props.match.params.id &&
            getHotelList({ id: this.props.match.params.id }).then((res: any) => {
                        ...
                        <div className="col-lg-11">
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div className="card mt-2">
                                    ...
                                    <b> {this.props.match.params.id ?'Update Hotel Price':'Add New Hotel Price' }</b>
                                    </div>
                                    <div className="card-body">
                                        <div className="row">
                                            ...
                                            <div className="col-lg-12 ">
                                                <Link to={CONSTANT.url.settingsOption.hotelList} className="col-lg-2 btn primary-control pull-left">Cancel</Link>
    ...
    private onSubmit = (e: any) => {
        ...
        if (validateForm(this)) {
            ...
            addHotel({ price, branchCategoryId, designationId, id }).then((res: any) => {
                this.setState({ showLoader: false })
                if (res) {
                    alert('record update sucessfully')
                    this.props.history.push(CONSTANT.url.settingsOption.hotelList)
                }
            })
