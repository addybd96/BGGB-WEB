...
import { addNewsPaper, getDesignations, getNewsPaperList } from '../../../action/SettingsActions';
...
class ComponentName extends React.Component<any, any> {
    ...
    componentDidMount() {
        ...
        this.props.match.params.id &&
            getNewsPaperList({ id: this.props.match.params.id }).then((res: any) => {
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div className="card mt-2">
                                    <div className="card-header">
                                        <b> {this.props.match.params.id ? 'Update News Price' : 'Add New Price'}</b>
                                    </div>
                                    <div className="card-body">
                                        <div className="row">
                                            ...
                                            <div className="col-lg-12 ">
                                                <Link to={CONSTANT.url.settingsOption.newPaperList} className="col-lg-2 btn primary-control pull-left">Cancel</Link>
    ...
    private onSubmit = (e: any) => {
        ...
        if (validateForm(this)) {
            ...
            addNewsPaper({ price, designationId, id }).then((res: any) => {
                this.setState({ showLoader: false })
                if (res) {
                    alert('record update sucessfully')
                    this.props.history.push(CONSTANT.url.settingsOption.newPaperList)
                }
            })
