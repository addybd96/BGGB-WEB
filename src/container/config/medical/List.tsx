...
import { getMedicalAllowanceList } from '../../../action/SettingsActions'
...
class ComponentName extends React.Component<any, any> {
                        ...
                        <div className="col-lg-11">
                            <div className="row mt-3">
                                <div className="col-lg-12">
                                    <h5 className="heading-h1">Medical Allowance</h5>
                                </div>
                            </div>
                            ...
                            <div className="card mt-3">
                                <div className="card-header">
                                    <div className="float-right">
                                        <Link to={CONSTANT.url.settingsOption.addMedical}>Add new Price</Link>
                                    </div>
                                                    ...
                                                    list !== undefined && list.length > 0 && list.map((l: any, i: any) => {
                                                        return (
                                                            <tr key={i}>
                                                                ...
                                                                <td className="text-center"> {l.date ? moment(l.date).format('YYYY') : ""} </td>
                                                                <th className="text-center"><Link to={CONSTANT.url.settingsOption.editMedical.replace(':id', l.id)}><i className="fas fa-edit"></i></Link></th>
                                                            </tr>
                                                        )
                                                    })
                                                }
    ...
    loadData = () => {
        ...
        getMedicalAllowanceList().then((res: any) => {
