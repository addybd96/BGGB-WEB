...
import { getDesignations, addMedicalAllowance, getMedicalAllowanceList } from '../../../action/SettingsActions';
...
class ComponentName extends React.Component<any, any> {
    ...
    componentDidMount() {
        ...
        getMedicalAllowanceList({ id: this.props.match.params.id }).then((res: any) => {
    ...
    public render() {
        const { showLoader, price, designationId, date } = this.state;
        return (
            <React.Fragment>
                <Header />
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div className="card mt-2">
                                    <div className="card-header">
                                        <b> {this.props.match.params.id ? 'Update Medical Price' : 'Add New Medical Price'}</b>
                                    </div>
                                    <div className="card-body">
                                        <div className="row">
                                            ...
                                            <div className="col-lg-12 ">
                                                <Link to={CONSTANT.url.settingsOption.medicalList} className="col-lg-2 btn primary-control pull-left">Cancel</Link>
    ...
    private onSubmit = (e: any) => {
        ...
        if (validateForm(this)) {
            const { price: { value: price }, designationId: { value: designationId }, date: { value: date }, id } = this.state;
            this.setState({ showLoader: true })
            addMedicalAllowance({ price, designationId, date, id }).then((res: any) => {
                this.setState({ showLoader: false })
                if (res) {
                    alert('record update sucessfully')
                    this.props.history.push(CONSTANT.url.settingsOption.medicalList)
                }
            })
        }
    }
