...
import { addBriefCase, getDesignations, getBriefCaseList } from '../../../action/SettingsActions';
...
class ComponentName extends React.Component<any, any> {
    ...
    componentDidMount() {
        ...
        this.props.match.params.id &&
            getBriefCaseList({ id: this.props.match.params.id }).then((res: any) => {
                                    ...
                                    <div className="card-body">
                                        <div className="row">
                                            ...
                                            <div className="col-lg-12 ">
                                                <Link to={CONSTANT.url.settingsOption.briefCaseList} className="col-lg-2 btn primary-control pull-left">Cancel</Link>
    ...
    private onSubmit = (e: any) => {
        ...
        if (validateForm(this)) {
            ...
            addBriefCase({ price, designationId, id }).then((res: any) => {
                this.setState({ showLoader: false })
                if (res) {
                    alert('record update sucessfully')
                    this.props.history.push(CONSTANT.url.settingsOption.briefCaseList)
                }
            })
