...
import { getBriefCaseList } from '../../../action/SettingsActions'
...
class ComponentName extends React.Component<any, any> {
                    ...
                    <div className="row">
                        ...
                        <div className="row mt-3">
                                <div className="col-lg-12">
                                    <h5 className="heading-h1">Brief Case </h5>
                                </div>
                            </div>
                            ...
                            <div className="card mt-3">
                                <div className="card-header">
                                    <div className="float-right">
                                        <Link to={CONSTANT.url.settingsOption.addBriefCase}>Add new Price</Link>
                                    </div>
                                                    ...
                                                    list !== undefined && list.length > 0 && list.map((l: any, i: any) => {
                                                        return (
                                                            <tr key={i}>
                                                                ...
                                                                <th className="text-center"><Link to={CONSTANT.url.settingsOption.editBriefCase.replace(':id', l.id)}><i className="fas fa-edit"></i></Link></th>
                                                            </tr>
                                                        )
                                                    })
                                                }
    ...
    loadData = (date?: any) => {
        ...
        getBriefCaseList({ date }).then((res: any) => {
