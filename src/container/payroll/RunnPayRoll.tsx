...
import { runPayRoll } from '../../action/PayrollCycleAction';
...
class ComponentName extends React.Component<any, any> {
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row">
                                                <div className="col-lg-4">
                                                    <label>Select PayRoll Process Date </label>
                                                </div>
                                                <div className="col-lg-4">
                                                    <input
                                                        type="date"
                            ...
                            <div className="card mt-3">
                                <div className="card-header">
                                    <div className="float-left">
                                        <b>Payroll cycle </b> {date.value ? moment(date.value).startOf('month').format('MMM Do') : moment().startOf('month').format('MMM Do')} - {date.value ? moment(date.value).endOf('month').format('MMM Do') : moment().endOf('month').format('MMM Do YYYY')}
                                    </div>
                                    <div className="float-right">
                                        <b><Link to={CONSTANT.url.payrollCycleEmployeeList}>Payroll Detail</Link> </b>
                                    </div>
                                </div>
                                <div className="card-body">
                                        ...
                                        <table className="table table-striped">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th className="text-center" scope="col">  Total Day </th>
                                                    <th className="text-center" scope="col">  Working Day </th>
                                                        ...
                                                        if (l)
                                                            return (
                                                                <tr key={i}>
                                                                    ...
                                                                    <td> {l.totalDeduc} </td>
                                                                    <td> {l.net} </td>
                                                                    <td> { moment(l.date).daysInMonth()} </td>
                                                                    <td> {l.workingDay} </td>
                                                                </tr>
                                                            )
                                                    })
    ...
    submit = (e: any) => {
        ...
        if (validateForm(this)) {
            ...
            runPayRoll({ date: this.state.date.value }).then((res: any) => {
