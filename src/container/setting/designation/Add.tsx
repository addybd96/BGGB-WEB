...
import { addDesignations } from '../../../action/SettingsActions';
import CONSTANT from '../../../constant';

class AddDepartment extends React.Component<any, any> {
                                    ...
                                    <div className="col-lg-12 mt-4">
                                        <div className="row">
                                            <div className="col-lg-6 pl-0">
                                                <h5 className="heading-h1">Add Designations</h5>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="card mt-2">
                                        ...
                                        <div className="card-body">
                                            <div className="row">
                                                ...
                                                <div className="col-lg-12 ">
                                                    <button className="col-lg-2 btn primary-control pull-right">Submit</button>
                                                </div>
    ...
    _submitForm = (e: any) => {
        ...
        if (isFormValid) {
            ...
            addDesignations(jsonToPost).then((response: any) => {
