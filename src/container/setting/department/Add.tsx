...
import { addDepartments } from '../../../action/SettingsActions';
...
class AddDepartment extends React.Component<any, any> {
                                    ...
                                    <div className="col-lg-12 mt-4">
                                        <div className="row">
                                            <div className="col-lg-6 pl-0">
                                                <h5 className="heading-h1">Add Department</h5>
                                            </div>
                                        </div>
                                    </div>
    ...
    _submitForm = (e: any) => {
        ...
        if (isFormValid) {
            ...
            addDepartments(jsonToPost).then((response: any) => {
                console.log("add dept response  => ", response);
                if (response.status) {
