...
class ListLeave extends React.Component<any, any> {
                            ...
                            <div className="card">
                                <div className="card-header">
                                    ...
                                    <div className="float-right">
                                        <Link to={CONSTANT.url.settingsOption.addBranchCategory}>
                                            <a className="common-btn">
                                                <i className="fa fa-plus"></i> &nbsp;Add Branch Category
                                                </a>
                                        </Link>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                }
                                                {
                                                    list !== undefined && list.map((item: any, index: number) => {
                                                        const url = CONSTANT.url.settingsOption.editBranchCategory.replace(':id', item.id);
    ...
    loadList = () => {
        ...
        getBranchCategories(page, limit).then((res: any) => {
            this.setState({
                list: res.result
            })
        }).catch((err: any) => {
