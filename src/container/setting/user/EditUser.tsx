...
import { getUserRole, updateUser } from './../../../action/SettingsActions';
...
class EditUser extends React.Component<any, any> {
    constructor(props: any) {
        super(props);
        this.state = {
            employeeId: props.location.state.employeeId,
            userName: { name: 'userName', value: props.location.state.fullName, error: '', isRequired: true },
            userEmail: { name: 'userEmail', value: props.location.state.emailId, error: '', isRequired: false },
            userMobileNo: { name: 'userMobileNo', value: props.location.state.mobileNumber, error: '', isRequired: true },
            role: { name: 'role', value: props.location.state.roleId, error: '', options: [], isRequired: true },
            loginStatusId: { name: 'loginStatusId', value: props.location.state.roleId, error: '', options: [], isRequired: true },
        }
    }
    ...
    public render() {
        const { employeeId, userName, userEmail, userMobileNo, role, loginStatusId } = this.state;
                            ...
                            <form onSubmit={this._submitForm}>
                                <div className="row">
                                    <div className="col-lg-12">
                                        <h5 className="heading-h1">Update User</h5>
                                    </div>
                                </div>
    ...
    _submitForm = (e: any) => {
        ...
        if (validateForm(this)) {
            ...
            console.log("update user jsonToPost  => ", jsonToPost);
            updateUser(jsonToPost).then((response: any) => {
