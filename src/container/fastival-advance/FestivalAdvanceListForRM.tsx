...
import { getFastivalAdvanceEmp, getFastivalAdvanceEmpForRM } from '../../action/FastivalAdvanceAction'
import { getCookie } from '../../utils';

class FestivalAdvanceListForRM extends React.Component<any, any> {
                            ...
                            <div className="card mt-2">
                                ...
                                <div className="card-body">
                                    <div className="table-responsive">
                                        <FastivalEmpList fastivalList={fastivalList} loadList={this.loadList} count={count} page={page} limit={limit} onTableChange={this.onTableChange} />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    loadList = (page: any, limit: any) => {
        ...
        getFastivalAdvanceEmpForRM(page, limit)
            .then((res: any) => {
...
export default FestivalAdvanceListForRM;
