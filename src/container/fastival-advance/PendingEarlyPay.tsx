...
import FastivalPendingList from '../../component/FastivalAdvance/EarlyPendingList'

import { getEarlyPendingFastivalAdvanceApplications } from '../../action/FastivalAdvanceAction'
import { getCookie } from '../../utils';

class PendingFestivalEarlyPayList extends React.Component<any, any> {
                            ...
                            <div className="col-lg-12">
                                <div className="row">
                                    <div className="col-lg-6 pl-0">
                                        <h5 className="heading-h1">Pending Early Fastival Advance</h5>
                                    </div>
    ...
    loadList = (page: any, limit: any) => {
        ...
        getEarlyPendingFastivalAdvanceApplications(page, limit, this.state.userType)
            .then((res: any) => {
                if (res.result) {
...
export default PendingFestivalEarlyPayList;
