...
import { getFastivalAdvance } from '../../action/FastivalAdvanceAction'
import { getCookie } from '../../utils';

class AdminFestivalList extends React.Component<any, any> {
                        ...
                        <div className="col-lg-11 my-3">
                            <div className="col-lg-12">
                                <div className="row">
                                    <div className="col-lg-6 pl-0">
                                        <h5 className="heading-h1">Festival Advance</h5>
                                    </div>
                            ...
                            <div className="card mt-2">
                                <div className="card-header">
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <b>Festival Advance </b>
                                        </div>
                                    </div>
                                </div>
                                <div className="card-body">
                                    <div className="table-responsive">
                                        <FastivalList fastivalList={fastivalList} loadList={this.loadList} count={count} page={page} limit={limit} onTableChange={this.onTableChange} />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    loadList = (page: any, limit: any) => {
        ...
        getFastivalAdvance(page, limit, this.state.userType)
            .then((res: any) => {
                if (res.result) {
