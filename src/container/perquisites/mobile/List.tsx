...
import { getAuthHeader, onChange, textTransform } from "../../../utils";
import { getMobileAlneByUserId, updateMobileAllowanceWithdrawl } from "../../../action/MobileAction";
...
class ComponentName extends React.Component<any, any> {
      ...
      <React.Fragment>
        ...
        <div className="fluid-container px-0">
          <div className="row">
            ...
            <b>Mobile Allowance</b>
              <div className="card mt-3">
                <div className="card-header">
                  <div className="float-right">
                    <Link to={CONSTANT.url.perquisites.mobileAddAllowance}>
  ...
  updateWithdrawl = (payload: any) => {
    ...
    updateMobileAllowanceWithdrawl(model).then((resp: any) => {
