...
import { getMobileAlneById, approve } from '../../../action/MobileAction'
...
class ComponentName extends React.Component<any, any> {
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-12 mb-2">
                                                <div className="row">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-12 mb-2">
                                                            <img src={`${process.env.REACT_APP_BASE_URL}/userMobile/${imgUrl}`} alt="" />
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6 form-group">
                                                        <label>Status</label>
                                            ...
                                            {Status && (Status == "pending" || Status == "forward") &&
                                                <div className="col-lg-12 ">
                                                    <Link to={CONSTANT.url.perquisites.mobilePendingAllowance} className="col-lg-2 btn primary-control pull-left">Cancel</Link>
    ...
    loadData = () => {
        ...
        getMobileAlneById({ id }).then((res: any) => {
            this.setState({ showLoader: false })
            if (res === undefined || res === "undefined") {
                this.props.history.push(CONSTANT.url.perquisites.mobilePendingAllowance)
            } else {
                this.setState({
                    id: res.id,
                    userId: res.userId,
    ...
    private onSubmit = (e: any) => {
        ...
        if (validateForm(this)) {
            ...
            this.setState({ showLoader: true })
            approve({ userId, actualAmount: actualAmount.value, amount: amount.value, remarks:remarks.value, date: date.value, status: status.value, id }).then((res: any) => {
                this.setState({ showLoader: false })
                if (res) {
