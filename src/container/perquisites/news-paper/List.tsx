...
import { getNewsPaperAlneByUserId, updateNewsPaperAllowanceWithdrawl } from '../../../action/NewsPaperActions'
...
class ComponentName extends React.Component<any, any> {
                ...
                <div className="fluid-container px-0">
                    <div className="row">
                        ...
                        <div className="col-lg-11">
                            <b>News Paper Allowance</b>
                            <div className="card mt-3">
                                <div className="card-header">
                                    <div className="float-right">
                                        <Link to={CONSTANT.url.perquisites.newsPaperAddAllowance}><i className="fa fa-plus"></i></Link>
                                    </div>
    ...
    updateWithdrawl = (payload: any) => {
        ...
        updateNewsPaperAllowanceWithdrawl(model).then((resp: any) => {
            this.dismissModal()
            this.loadData()
            alert(resp.message)
        })
