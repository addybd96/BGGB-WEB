...
import { getNewsPaperAlneById, approve } from '../../../action/NewsPaperActions'
...
class ComponentName extends React.Component<any, any> {
    ...
    public render() {
        const { showLoader, Status, date, amount, status, actualAmount, approvalStatus,remarks } = this.state;
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div className="card mt-2">
                                    <div className="card-header">
                                        <b>Approve Newspaper Allowance</b>
                                    </div>
                                        ...
                                        <div className="row">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-6 form-group">
                                                        ...
                                                        <NumberFormat
                                                            ...
                                                            value={status.value == 'reject' ? 0:actualAmount.value} 
                                                    ...
                                                    <div className="col-lg-6 form-group">
                                                        ...
                                                        <input
                                                            ...
                                                            name={date.name}
                                                            value={moment(date.value).format('YYYY')}
                                            ...
                                            {Status && (Status == "pending" || Status == "forward") &&
                                                <div className="col-lg-12 ">
                                                    <Link to={CONSTANT.url.perquisites.newsPaperPendingAllowance} className="col-lg-2 btn primary-control pull-left">Cancel</Link>
        ...
        if (validateForm(this)) {
            ...
            approve({ userId, actualAmount: actualAmount.value, remarks:remarks.value, amount: amount.value, date: date.value, status: status.value, id }).then((res: any) => {
                ...
                if (res) {
                    ...
                    this.props.history.push(CONSTANT.url.perquisites.newsPaperPendingAllowance)
                }
            })
