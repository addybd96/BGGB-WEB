...
import { getNewsPaperAlne } from '../../../action/UniformAndLiveriesAction'
                            ...
                            <div className="card mt-3">
                                <div className="card-header">
                                    ...
                                    <div className="float-left ">
                                        <b>Uniform And Liveries Allowance Pending</b>
                                                        ...
                                                        return (
                                                            <tr key={i}>
                                                                ...
                                                                {l.showAction && (
                                                                      ...
                                                                      <Link to={CONSTANT.url.perquisites.uniformAndLiveriesApproveAllowance.replace(':id', l.id)} >
