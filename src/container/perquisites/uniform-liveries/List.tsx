...
import {
  getNewsPaperAlneByUserId,
  updateuniformAllowanceWithdrawl,
...
class ComponentName extends React.Component<any, any> {
  ...
  public render() {
    const { list, status, isModalOpen, showLoader } = this.state;
    return (
      <React.Fragment>
        <Header />
        <div className="fluid-container px-0">
          <div className="row">
            ...
            <div className="col-lg-11">
              <b>Uniform And Liveries Allowance</b>
              <div className="card mt-3">
                <div className="card-header">
                  <div className="float-right">
                    <Link
                      to={
                        CONSTANT.url.perquisites.uniformAndLiveriesAddAllowance
                      }
                    >
  ...
  updateWithdrawl = (payload: any) => {
    ...
    updateuniformAllowanceWithdrawl(model).then((resp: any) => {
      this.dismissModal();
      this.loadData();
      alert(resp.message)
    });
