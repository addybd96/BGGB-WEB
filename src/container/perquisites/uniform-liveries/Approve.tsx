...
import { getNewsPaperAlneById, approve } from '../../../action/UniformAndLiveriesAction'
...
class ComponentName extends React.Component<any, any> {
    constructor(props: any) {
        ...
        this.state = {
            ...
            allowanceName: "Uniform and Liveries",
        }
    }
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div className="card mt-2">
                                    <div className="card-header">
                                        <b>Approve Uniform and Liveries</b>
                                    </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-12 mb-2">
                                                <div className="row">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-12 mb-2">
                                                            <img src={`${process.env.REACT_APP_BASE_URL}/userUniformAndLiveries/${imgUrl}`} alt="" />
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6 form-group">
                                                        <label>Status</label>
                                            ...
                                            {Status && (Status == "pending" || Status == "forward") &&
                                                <div className="col-lg-12 ">
                                                    <Link to={CONSTANT.url.perquisites.uniformAndLiveriesPendingAllowance} className="col-lg-2 btn primary-control pull-left">Cancel</Link>
        ...
        if (validateForm(this)) {
            ...
            approve({ userId, actualAmount: actualAmount.value,remarks:remarks.value, amount: amount.value, date: date.value, status: status.value, id }).then((res: any) => {
                ...
                if (res) {
                    ...
                    this.props.history.push(CONSTANT.url.perquisites.uniformAndLiveriesPendingAllowance)
                }
            })
