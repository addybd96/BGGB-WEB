...
import { getTrevelAln } from "../../../action/PerqTravelAllowanceAction";
...
class ComponentName extends React.Component<any, any> {
                            ...
                            return (
                              <tr key={i}>
                                ...
                                {l.showAction && (
                                  <td className="text-center">
                                    <Link
                                      to={CONSTANT.url.perquisites.vapproveAllowance.replace(
                                        ":id",
                                        l.id
                                      )}
                                    >
  ...
  loadData = (status?: any) => {
    ...
    getTrevelAln({ status }).then((res: any) => {
