...
import { getNewsPaperAlneById, approve } from '../../../action/BriefCasePaperActions'
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-12 mb-2">
                                                <div className="row">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-12 mb-2">
                                                            <img src={`${process.env.REACT_APP_BASE_URL}/userBriefCase/${imgUrl}`} alt="" />
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6 form-group">
                                                        <label>Status</label>
        ...
        if (validateForm(this)) {
            ...
            approve({ userId, actualAmount: actualAmount.value,remarks:remarks.value, amount: amount.value, date: date.value, status: status.value, id }).then((res: any) => {
                ...
                if (res) {
                    ...
                    this.props.history.push(CONSTANT.url.perquisites.briefCasePaperPendingAllowance)
                }
            })
