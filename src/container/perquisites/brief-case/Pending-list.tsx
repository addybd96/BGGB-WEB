...
import { getNewsPaperAlne } from '../../../action/BriefCasePaperActions'
                        ...
                        <div className="col-lg-11">
                            <div className="card mt-3">
                                <div className="card-header">
                                    ...
                                    <b >BriefCase Allowance pending</b>
                                                        ...
                                                        return (
                                                            <tr key={i}>
                                                                ...
                                                                </td>
                                                                {
                                                                    ...
                                                                    <Link to={CONSTANT.url.perquisites.briefCasePaperApproveAllowance.replace(':id', l.id)} >
