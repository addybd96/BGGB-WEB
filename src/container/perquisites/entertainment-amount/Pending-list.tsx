...
import { getNewsPaperAlne } from '../../../action/EntertainmentAction'
                        ...
                        <div className="col-lg-11">
                            <div className="card mt-3">
                                <div className="card-header">
                                    ...
                                    <b>Entertainment Allowance Pending</b>
                                    </div>
                                </div>
                                <div className="card-body">
                                        ...
                                        <table className="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th className="text-center" scope="col">  Actual Amount </th>
                                  ...
                                  </td>
                                  {
                                      l.showAction && 
                                      <td className="text-center">
                                          <Link to={CONSTANT.url.perquisites.entertainmentApproveAllowance.replace(':id', l.id)} >
