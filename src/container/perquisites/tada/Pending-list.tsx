...
import { getTadaAln } from '../../../action/PerqTadaAllowanceAction'
...
class ComponentName extends React.Component<any, any> {
                                        ...
                                        <table className="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th className="text-center"> Hotel Amount Paid Per Day</th>
                                                            ...
                                                            <tr key={i}>
                                                               ...
                                                               <td className="text-center">{l.hrRemarks}</td> 
                                                                ...
                                                                {l.showAction && (
                                                                      ...
                                                                      <Link to={CONSTANT.url.perquisites.tadaApproveAllowance.replace(':id', l.id)} >
    ...
    loadData = (status?: any) => {
        ...
        getTadaAln({ status }).then((res: any) => {
