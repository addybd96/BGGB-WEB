...
import { approve, getTadaAlneById } from '../../../action/PerqTadaAllowanceAction'
...
class ComponentName extends React.Component<any, any> {
    constructor(props: any) {
        ...
        this.state = {
            ...
            autoRixaExpense: { name: 'autoRixaExpense', value: '', error: '', isRequired: true },
            hotelAmountPaidPerDay: { name: 'hotelAmountPaidPerDay', value: '', error: '', isRequired: true },
            totalAmount: { name: 'totalAmount', value: '', error: '', isRequired: true },
            ...
            hr_recommend:{ name: 'hr_recommend', value: false, error: '', isRequired: true },
            hr_remarks:{ name: 'hr_remarks', value: '', error: '', isRequired: true },
            showLoader: false,
    ...
    public render() {
        const { showLoader, Status, tada, totalTada, farePaid, autoRixaExpense, hotelAmountPaidPerDay,remarks,hr_recommend, hr_remarks, purpose, date, status, totalAmount, approvalStatus } = this.state;
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-12 mb-2" style={{ borderTop: "1px dotted black;", marginTop: "25px;" }}>
                                                            ...
                                                            <div className="row" >
                                                                ...
                                                                <div className="col-lg-3 form-group">
                                                                    <label>Is hotel facility availed (Yes, No)</label>
                                                                    <select
                                                                        disabled
                                                                        className="form-control"
                                                                ...
                                                                <div className="col-lg-3 form-group">
                                                                    ...
                                                                    <NumberFormat
                                                                        disabled
                                                                        className={e.km.error.length > 0 ? "form-control is-invalid" : "form-control"}
                                                                        name={e.km.name}
                                                                        value={e.km.value}
                                                                ...
                                                                <div className="col-lg-3 form-group">
                                                                    ...
                                                                    <NumberFormat
                                                                        disabled
                                                                        className={e.tada.error.length > 0 ? "form-control is-invalid" : "form-control"}
                                                                        name={e.tada.name}
                                                                        value={e.tada.value}
                                                                ...
                                                                <div className="col-lg-3 form-group">
                                                                    ...
                                                                    <NumberFormat
                                                                        disabled
                                                                        className={e.farePaid.error.length > 0 ? "form-control is-invalid" : "form-control"}
                                                                ...
                                                                <div className="col-lg-3 form-group">
                                                                    ...
                                                                    <NumberFormat
                                                                        disabled
                                                                        className={e.autoRixaExpense.error.length > 0 ? "form-control is-invalid" : "form-control"}
                                                                ...
                                                                <div className="col-lg-3 form-group">
                                                                    ...
                                                                    <NumberFormat
                                                                        disabled
                                                                        className={e.hotelAmountPaidPerDay.error.length > 0 ? "form-control is-invalid" : "form-control"}
                                            ...
                                            <div className="col-lg-12 mb-2">
                                                <div className="row" >
                                                    <div className="col-lg-3 form-group">
                                                        ...
                                                        <NumberFormat
                                                            disabled
                                                            className={totalTada.error.length > 0 ? "form-control is-invalid" : "form-control"}
                                                            name={totalTada.name}
                                                    ...
                                                    <div className="col-lg-3 form-group">
                                                        ...
                                                        <NumberFormat
                                                            disabled
                                                            className={farePaid.error.length > 0 ? "form-control is-invalid" : "form-control"}
                                                            name={farePaid.name}
                                                    ...
                                                    <div className="col-lg-3 form-group">
                                                        ...
                                                        <NumberFormat
                                                            disabled
                                                            className={autoRixaExpense.error.length > 0 ? "form-control is-invalid" : "form-control"}
                                                    ...
                                                    <div className="col-lg-3 form-group">
                                                        ...
                                                        <NumberFormat
                                                            disabled
                                                            className={hotelAmountPaidPerDay.error.length > 0 ? "form-control is-invalid" : "form-control"}
                                                    ...
                                                    <div className="col-lg-3 form-group">
                                                        ...
                                                        <NumberFormat
                                                            disabled
                                                            className={totalAmount.error.length > 0 ? "form-control is-invalid" : "form-control"}
                                                    ...
                                                    <div className="col-lg-6 form-group">
                                                        <label>1)Reason 2)Tour Approving Authority</label>
                                                        <textarea
                                                            disabled
                                                            cols={10}
                                                            rows={5}
                                                            name={purpose.name}
                                                            value={purpose.value}
                                                            className={purpose.error.length > 0 ? "form-control is-invalid" : "form-control"}
                                                        ></textarea>
                                                    </div>
                                                ...
                                                <div className="col-lg-12">
                                                    ...
                                                    >
                                                        ...
                                                        {approvalStatus === true && hr_recommend.value ? <option value="approved">Approved</option> : ""}
                                                    </select>
                                                </div>
                                                <div className="col-lg-6 form-group">
                                                        <label>Remarks</label>
                                                ...
                                                <div className="col-lg-12">
                                                    ...
                                                    <div className="col-lg-6 form-group">
                                                        ...
                                                        <input
                                                            ...
                                                            value={hr_recommend.value ? 'YES':'NO'}
                                                        />
                                                    </div>
                                                    <div className="col-lg-6 form-group">
                                                ...
                                                
                                                {
                                                    ...
                                                    <div className="col-lg-12 ">
                                                        <Link to={CONSTANT.url.perquisites.tadaPendingAllowance} className="col-lg-2 btn primary-control pull-left">Cancel</Link>
            ...
            if (response) {
                const tada = response.list.map((res: any) => {
                    return {
                        ...
                        departureCategory: { name: "departureCategory", value: res.departureCategory },
                        departurePalace: { name: "departurePalace", value: res.departurePalace },
                        departureDate: { name: "departureDate", value: moment(res.departureDate).format('YYYY-MM-DD') },
                        departureTime: { name: "departureTime", value: moment(res.departureTime, "HH:mm").format('hh:mm') },
                        arrivalDate: { name: "arrivalDate", value: moment(res.arrivalDate).format('YYYY-MM-DD') },
                        arrivalTime: { name: "arrivalTime", value: moment(res.arrivalTime, "HH:mm").format('hh:mm') },
                        arrivalPalace: { name: "arrivalPalace", value: res.arrivalPalace },
                        arrivalCategory: { name: "arrivalCategory", value: res.arrivalCategory },
                        ...
                        tada: { name: "tada", value: res.tada, error: '', isRequired: true },
                        farePaid: { name: "farePaid", value: res.farePaid, error: '', isRequired: true },
                        autoRixaExpense: { name: "autoRixaExpense", value: res.autoRixaExpense, error: '', isRequired: true },
                        isHotelFacilityAvailed: { name: "isHotelFacilityAvailed", value: res.isHotelFacilityAvailed },
                        hotelAmountPaidPerDay: { name: "hotelAmountPaidPerDay", value: res.hotelAmountPaidPerDay, error: '', isRequired: res.isHotelFacilityAvailed ? true : false }
                    }
                }
                )
                this.setState({
                    ...
                    totalTada: { name: "totalTada", value: response.totalTada, error: '' },
                    autoRixaExpense: { name: "autoRixaExpense", value: response.autoRixaExpense, error: '' },
                    hotelAmountPaidPerDay: { name: "hotelAmountPaidPerDay", value: response.hotelAmountPaidPerDay, error: '' },
                    totalAmount: { name: "totalAmount", value: response.totalAmount, error: '', isRequired: true },
                    purpose: { name: "purpose", value: response.purpose, error: '' },
                    date: { name: "date", value: moment(response.date).format('YYYY-MM-DD'), error: '' },
                    status: { name: "status", value: response.status === 'pending' ? '' : response.status, error: '', isRequired: true, },
                    showLoader: false,
                    hr_recommend:{name:"hr_recommend", value:response.isHrRecommended,  error: '' },
                    hr_remarks:{ name: "hr_remarks", value: response.hrRemarks, error: '' }
                })
    ...
    private onSubmit = (e: any) => {
        ...
        if (true) {
            ...
            const model = {
                ...
                hotelAmountPaidPerDay: this.state.isHotelFacilityAvailed === "true" ? this.state.hotelAmountPaidPerDay.value : 0,
                remarks:this.state.remarks.value,               
                 isHrRecommended:this.state.hr_recommend.value==true?true:false,         
                 hrRemarks:this.state.hr_remarks.value !==undefined ? this.state.hr_remarks.value : null
            }
            ...
            approve(model).then((res: any) => {
                ...
                if (res) {
                    ...
                    this.props.history.push(CONSTANT.url.perquisites.tadaPendingAllowance)
                }
            })
        }
    }
