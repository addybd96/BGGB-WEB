...
import { getIncrementList } from '../../action/IncrementAction';

class IncrementList extends React.Component<any, any> {
                                ...
                                <div className="card-header">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-2 text-right pr-0">
                                            {/* {userType === 'radmin' && */}
                                            <Link to={CONSTANT.url.increment.basicAdd}>
                                        ...
                                        <table className="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Basic </th>
                                                    <th>Increment Of Basic </th>
                                                    <th>Revision Of Basic</th>
                                            ...
                                            <tbody>
                                                ...
                                                {incrementList.map((item: any, index: number) => {
                                                    ...
                                                    return (<tr>
                                                        ...
                                                        <td>{item.basic}</td>
                                                        <td>{item.incrementBasicAmount}</td>
                                                        <td>{item.revisionBasic}</td>
