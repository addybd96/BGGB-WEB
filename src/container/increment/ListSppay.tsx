...
import { getIncrementList, getIncrementListPqp, getIncrementListSppay } from '../../action/IncrementAction';

class IncrementListSppay extends React.Component<any, any> {
                                ...
                                <div className="card-header">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-2 text-right pr-0">
                                            {/* {userType === 'radmin' && */}
                                            <Link to={CONSTANT.url.increment.sppayAdd}>
                                            ...
                                            <tbody>
                                                ...
                                                {incrementList.map((item: any, index: number) => {
                                                    ...
                                                    return (<tr>
                                                        ...
                                                        <td>{item.sppay}</td>
                                                        <td>{item.incrementSppayAmount}</td>
                                                        <td>{item.revisionSppay}</td>
...
export default IncrementListSppay;
