...
class EmployeeLeaveReportsAdmin extends React.Component<any, any> {
  ...
  onSubmit = () => {
    ...
    getEmployeeLeaveReportsAdmin(data).then((res: any) => {
...
export default EmployeeLeaveReportsAdmin;
